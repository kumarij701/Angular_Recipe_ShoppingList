...
export class AddIngredient implements Action{
    //Action interface forces 'type' Property
   readonly type = ADD_INGREDIENT;
   //payload: Ingredient; //payload is of type Ingredient
...
export type ShoppingListActions = AddIngredient | AddIngredients | UpdateIngredient | DeleteIngredient | StartEdit | StopEdit; // TS feature , value could be either of them